           ...
           c = NemployeeID.Length;
            if (c >= 5 && upload==false)
            {
                ...
                if (dt.Rows[0][0].ToString() == "1")
                {
                    ...
                    SqlCommand SelectCommand = new SqlCommand(string.Format("select Location,Name,Title,SupervisorName,FullPart,Shift,Reg_Temp,Work_Center,CostCenter,HireDate,DeptID,Reg_Temp from  dbo.Employee_Information where EmployeeID='{0}'", NemployeeID), SqlConn);
                    try
                    {
                        ...
                        while (myreader.Read())
                        {
                            ...
                            txtLastName.Text = NemployeeName.Substring(0, x );
                            if (v > -1) { txtMiddleName.Text = NemployeeName.Substring(v, x-1); }else { txtMiddleName.Text = ""; }
                            ...
                            if (w != namecheck) { txtMiddleName.Text = ""; }
