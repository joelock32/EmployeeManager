    ...
    public partial class Form1 : Form
    {
        ...
        public void handeldataexcel()//us&china excel file types
        {
            ...
            for (int i = 0; i < gridView1.RowCount; i++)
            {
                ...
                //string S1 = string.Format("SELECT COUNT(*) FROM {2} where Name='{0}' and EmployeeID='{1}'", NemployeeName, NemployeeID, MainTable);
        ...
        private bool ConfirmUser()
        {
            ...
            if (InputBox("Confirm Current User?", "Comfirm Employee ID:", ref value) == DialogResult.OK)
            {
                ...
                if(employeeID=="06539" || employeeID == "04357" || employeeID == "04838") { hyperLinkEdit1.Visible = true; }
                checkArea();
